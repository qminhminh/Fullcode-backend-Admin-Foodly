...
async function rejectionDriverEmail(userEmail, name){
    ...
    const mailOptions = {
        ...
        html: ` <h2>Foodly Driver Verification Rejected</h2>

        <p>Dear ${name},</p>
    
        <p>We regret to inform you that the verification process for your driver account on Foodly has been rejected. We appreciate your efforts in completing the verification, but unfortunately, it did not meet our requirements at this time.</p>
